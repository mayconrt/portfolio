...
import { FaInstagram, FaFacebookF, FaLinkedin, FaMailBulk, FaGithub } from 'react-icons/fa'
...
export default function Home() {
    return (
        <section id="ma-serction-home" className="ma-serction-div-home">
            <div className="ma-slider-main">
                <div className="ma-slider">
                    <img alt="Capa Trindade RJ" src={imgHome} />
            ...
            <div className="ma-card-home">
                ...
                <div className="ma-box ma-column-tree first">
                    ...
                    <div className="ma-card-socials"><img alt="Maycon Albuquerque" src={imgPerfil} /></div>
                ...
                <div className="ma-box ma-column-tree last_column second" >
                    ...
                    <div className="ma-card-socials"><img alt="Maycon Albuquerque" src={imgSocial} /></div>
                    <div className="ma-box-content">
                        ...
                        <div className="ma-socials-default">
                            ...
                            <div className="ma-icon">
                                <a target="_blank" rel="noopener noreferrer" href="https://github.com/mayconrt" title="Linkedin">< FaGithub size="20" /></a>
                            </div>
                        </div>
                    </div>
                </div>
